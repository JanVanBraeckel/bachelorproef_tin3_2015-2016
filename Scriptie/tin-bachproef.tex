...
\newcommand{\titel}{Bluetooth Low Energy wearables in an Internet of Things cloud infrastructure using a smartphone as gateway}

% Datum van indienen
\newcommand{\datum}{29 mei 2015}

% Faculteit
\newcommand{\faculteit}{Faculty `Bedrijf en Organisatie'}

% Soort rapport
\newcommand{\rapporttype}{Thesis submitted in fulfillment of the requirements for the degree of\\Bachelor in applied computer sciences}
...
\newcommand{\examenperiode}{Second exam period}
