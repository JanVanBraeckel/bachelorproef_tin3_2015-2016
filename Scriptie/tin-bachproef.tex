...
There are loads of other technologies that can be used to power the Internet of Things, but we won't go too much in depth in these. Some of these technologies and protocols are X10 (home automation), KNX (home automation) and M-bus (industry). Other very big technologies, not necessarily in the Low Energy/Low Range spectrum are LoRa (Long Range), GPRS (cellular) and Sigfox (Long Range).
