...
\begin{abstract}
The Internet of Things is today's buzzword when talking about future technology. A lot of companies are investing in it with new devices being made and connected to the internet every day.

Around the same time of the release of IPv6, which provides a near inexhaustible number of IP addresses, Bluetooth Low Energy made it to the market as well. This specification aims to be the go-to technology when manufacturing low energy wearables and in the future, make it into the houses of everyone with updates like mesh networking which will help home automation.
