...
\section{The Bluetooth Low Energy protocol}
\label{sec:protocolbasics}

\section{Generic Access Protocol}
\label{sec:gap}

\section{Generic Attribute Protocol}
\label{sec:gatt}

\subsection{GATT profiles}
...
\chapter{Building your own server or using an existing one}
\label{ch:server}
