    ...
    private String[] getAssetId(String[] parts, int offset) {
        ...
        for (int i = offset; i < parts.length; i++) {
            try {
                ...
                throw new UnsupportedOperationException(String.format("Failed to convert asset id to int[], problem with: %s in %s", parts[i], String.join("_", parts)));
            }
        }
    ...
    private void storeAssetId(String[] parts, int offset) {
        ...
        for (int i = offset; i < parts.length; i++) {
            try {
                ...
                throw new UnsupportedOperationException(String.format("Can't convert string to asset id: %s", String.join("_", parts)));
            }
        }
    }
